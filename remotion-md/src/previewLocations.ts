...
export interface PreviewCallLocation {
 ...
 * @returns Array of preview call locations, in order of appearance
 */
export function extractPreviewCallLocations(sourceFile: ts.SourceFile): PreviewCallLocation[] {
    const locations: PreviewCallLocation[] = [];

    function parseObjectLiteral(node: ts.ObjectLiteralExpression): PreviewPlayerOptions | undefined {
        const options: any = {};
